...
namespace MyProfile.Migrations
{
    ...
    [Migration("20210517065349_AdminIdentityAndAddressCreated")]
    partial class AdminIdentityAndAddressCreated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyProfile.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MyProfile.Models.Admin", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyProfile.Models.Admin", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyProfile.Models.Admin", b =>
                {
                    b.HasOne("MyProfile.Models.Address", "Address")
                        .WithMany()
